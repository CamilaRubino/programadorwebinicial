...
--
-- Servidor: localhost
-- Tiempo de generación: 15-02-2025 a las 18:39:08
...
CREATE TABLE IF NOT EXISTS `empleados` (
  `id emp` int(20) NOT NULL AUTO_INCREMENT,
...
(14, 'Daniel', 'Gutierrez', 'Administrador de sistema', 34, 900000, 'daniel@bignet.com'),
